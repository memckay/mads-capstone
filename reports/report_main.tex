...
We discovered that 35.8\% of physician groups operated in more than one ZIP code, making it necessary to devise a strategy to handle the overlap. MIPS results were connected to practice locations through the DAC directory, which was reduced to 227,313 unique organization ZIP pairs. Organization identifiers and ZIP codes were standardized before joining the datasets. 
